...
0. If using direnv and nix, cd into the directory and skip to step 5. There is a bundled nix flake and .envrc which will create a correct environment.
...
5. Run `npm install` to install all the dependencies for the project. This can take several minutes. Alternatively, use `pnpm install`.

6. Once you have the dependencies installed, run `npm start`. This will create a dev build and start watching for changes you make in the project folder and refresh your browser window. The development server will start at http://localhost:8080
